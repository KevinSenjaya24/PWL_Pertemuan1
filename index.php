...
<head>
    ...
    <meta name="author" content="Kevin Senjaya (1872042)">
...
<table id="myTable" class="display">
    ...
    <button class="button" onclick="callAlert()">Click Here</button>
    <button id="buttonSubmit" class="button" ">Click Here 2</button>
    <?php
        echo 'Hello From PHP' . '<br>';
        echo 'Good Morning' . ' ' . 'Kevin' . '<br>';
        $firstName = 'Kevin';
        $lastName = 'Senjaya';
        $bloodType = 'A';
        $age = '17';
